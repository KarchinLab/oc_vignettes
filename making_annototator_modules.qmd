...
sift_annotator/
├── data
│   └── sift_annotator.sqlite     ## contains annotations in sqlite format
├── sift_annotator.md             ## describes how to use annotator
├── sift_annotator.py             ## maps annotation columns to variant input
└── sift_annotator.yml            ## configures output columns
```
