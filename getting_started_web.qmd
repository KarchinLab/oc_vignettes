...
Now you're ready to browse the [OpenCRAVAT Store](#browse-annotators-web) to look for annotators.
...
Let's browse the clinically relevant annotators by clicking on the `Clinically Relevance` checkbox:

![](images/oc-browse-annotators-2.png)

As we browse the annotators available to us, we notice two specific annotators we want to work with. Let's use two annotators: [CiViC](https://civicdb.org/welcome) (Clinical Interpretations of Variants in Cancer) and [ClinVar](https://www.ncbi.nlm.nih.gov/clinvar/), a public archive of interpretations of clinically relevant patients. 
